...
from data import Vocabulary, UnicodeCharsVocabulary, LMDataset, BidirectionalLMDataset
...
def test_unicode():
    ...
    vocab_chars = Vocabulary(vocab_file, True)
    vocab_chars1 = Vocabulary(vocab_file1, True)
    vocab_unicodechars = UnicodeCharsVocabulary(vocab_file, vocab_file1, max_word_length=10, validate_file=True)
    print('====> bos: {}'.format(vocab_chars.bos))
    print('====> eos: {}'.format(vocab_chars.eos))
    print('====> unk: {}'.format(vocab_chars.unk))
    print('====> size: {}'.format(vocab_chars.size))
    ...
    print('====> bos1: {}'.format(vocab_chars1.bos))
    print('====> eos1: {}'.format(vocab_chars1.eos))
    print('====> unk1: {}'.format(vocab_chars1.unk))
    print('====> size1: {}'.format(vocab_chars1.size))
    ...
    print('====>vocab_unicodechars id to chars: {}'.format(list(vocab_unicodechars.word_char_ids)[:10]))
    #print('====> max word length: {}'.format(vocab_unicodechars.word_char_ids(0)))
    words = '云逸 听到 这 声音 十分 耳熟  第一副，'
    ...
    ids = [   2 , 224, 1420 ,   3  ,  4 ,   4  ,  4 ,   4,    4 ,   4]
    print('====> decode \t{}\t to words: {}'.format(ids, vocab_chars1.decode(ids)))
