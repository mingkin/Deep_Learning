...
class UnicodeCharsVocabulary(Vocabulary):
    ...
    """
    def __init__(self, word_filename,  max_word_length, **kwargs):
        # 调用父类Vocabulary，生成word和id之间的转换等
        super(UnicodeCharsVocabulary, self).__init__(word_filename, **kwargs)
        self._max_word_length = max_word_length

        char_file_name = '../vocab/vocab_seg_chars_elmo.txt'
        self.char_vocab = Vocabulary(char_file_name, True)
...
def _get_batch(generator, batch_size, num_steps, max_word_length):
    """Read batches of input. num_steps 为一行几个字窗口大小"""
    '''
    max_word_length是否为None决定句子是否调用char——inputs
    每次generator生成一个不定长句子，把一个不定长句子变成
    inputs [    0   803  4304  8102 28154 16625 27275 29019  5633 22650 17985 13946
      22650 29201 26219 15609  9991 22650 22426   617 11328 22650 27548 20076
       14090 11721  1419  4304  8609 25113  2279 28792 21476     0   803]
     targets [  803  4304  8102 28154 16625 27275 29019  5633 22650 17985 13946 22650
     29201 26219 15609  9991 22650 22426   617 11328 22650 27548 20076 14090
     11721  1419  4304  8609 25113  2279 28792 21476     1   803  4304]
    '''
    ...
    while True:
        ...
        for i in range(batch_size):
            ...
            while cur_pos < num_steps:
                # cur_stream当前位置 < num_steps窗口大小
                if cur_stream[i] is None or len(cur_stream[i][0]) <= 1:
                    try:
                        cur_stream[i] = list(next(generator)) #把不定长句子加入cur_stream[i]
                    except StopIteration:
                        # No more data, exhaust current streams and quit
                        no_more_data = True
                        break
                #cur_stream，[i][0]代表的是word_ids，[i][1]代表的是char_ids
                # len(cur_stream[i][0]) - 1 句子词的个数
                '''
                如果一个句子长度为10，窗口大小为5：
...
class LMDataset(object):
    ...
    def iter_batches(self, batch_size, num_steps):
        """一个生成数据的迭代器"""
        '''
        1.通过_load_random_shard 随机选一个文件读取
        2.然后迭代器生成句子get_sentence（） 一次只取一个句子
        3._get_batch
        '''
